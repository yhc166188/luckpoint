...
<html lang="en">
<head>
    <title>Code coverage report for api_common.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> api_common.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Aes = require("./aes")
...
&nbsp;
    ...
    */
    sign: (data, privateKey, encoding = 'utf8') =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === true) {
<span class="cstat-no" title="statement not covered" >          throw new TypeError('API changed, use signHash(..) instead')</span>
        } else {
          <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === false) {
<span class="cstat-no" title="statement not covered" >            console.log('Warning: ecc.sign hashData parameter was removed');</span>
          }
        }
...
&nbsp;
    ...
    */
    verify: (signature, data, pubkey, encoding = 'utf8') =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === true) {
<span class="cstat-no" title="statement not covered" >          throw new TypeError('API changed, use verifyHash(..) instead')</span>
        } else {
          <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === false) {
<span class="cstat-no" title="statement not covered" >            console.log('Warning: ecc.verify hashData parameter was removed');</span>
          }
        }
...
&nbsp;
    ...
    */
    recover: (signature, data, encoding = 'utf8') =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === true) {
<span class="cstat-no" title="statement not covered" >          throw new TypeError('API changed, use recoverHash(signature, data) instead')</span>
        } else {
          <span class="missing-if-branch" title="if path not taken" >I</span>if(encoding === false) {
<span class="cstat-no" title="statement not covered" >            console.log('Warning: ecc.recover hashData parameter was removed');</span>
          }
        }
        signature = Signature.from(signature)
