...
<html lang="en">
<head>
    <title>Code coverage report for key_utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> key_utils.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.06% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>58/69</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">129x</span>
<span class="cline-any cline-yes">129x</span>
<span class="cline-any cline-yes">8249214x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">129x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">38628x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
*/
function random32ByteBuffer({cpuEntropyBits = 0, safe = true} = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
&nbsp;
    ...
    for(const i of ints) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(i2 &gt; 9007199254740991)
<span class="cstat-no" title="statement not covered" >            externalEntropyArray[pos] = 0</span>
    }
}
&nbsp;
/**
...
function cpuEntropy(cpuEntropyBits = 128) {
    ...
    while(collected.length &lt; cpuEntropyBits) {
        ...
        if(lastCount != null) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(Math.abs(delta) &lt; 1) {
<span class="cstat-no" title="statement not covered" >                lowEntropySamples++</span>
<span class="cstat-no" title="statement not covered" >                continue</span>
            }
            // how many bits of entropy were in this sample
            const bits = Math.floor(log2(Math.abs(delta)) + 1)
            <span class="missing-if-branch" title="if path not taken" >I</span>if(bits &lt; 4) {
<span class="cstat-no" title="statement not covered" >                if(bits &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >                    lowEntropySamples++</span>
                }
<span class="cstat-no" title="statement not covered" >                continue</span>
            }
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if(lowEntropySamples &gt; 10) {
        const pct = <span class="cstat-no" title="statement not covered" >Number(lowEntropySamples / cpuEntropyBits * 100).toFixed(2)</span>
        // Is this algorithm getting inefficient?
<span class="cstat-no" title="statement not covered" >        console.warn(`WARN: ${pct}% low CPU entropy re-sampled`);</span>
    }
    return collected
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (let i = 0, mimeType; i &lt; navigator.mimeTypes.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            mimeType = navigator.mimeTypes[i];</span>
<span class="cstat-no" title="statement not covered" >            entropyStr += mimeType.description + " " + mimeType.type + " " + mimeType.suffixes + " ";</span>
        }
    } catch(error) {
